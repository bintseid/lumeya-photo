    ...
    <div className="min-h-screen bg-white text-[#1e1e27] flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <img src="/lumeya%27s%20logo.png" alt="Lumeya Logo" className="h-10 w-auto" />
            </div>
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input type="email" className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[#1e1e27]">Phone</label>
                  <Input className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[#1e1e27]">Message</label>
                  <Textarea className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" rows={4} />
                </div>
                <Button className="w-full bg-[#df0139] text-white hover:bg-[#df0139]/90 rounded-full font-semibold transition-all duration-300 hover:scale-105">
                  Send Message
                </Button>
      ...
      <footer className="mt-auto bg-[#e2e2e2]/50 border-t border-[#28242a]/20 py-8 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-[#28242a]/70">© 2024 Lumeya. All rights reserved.</p>
        </div>
      </footer>

      {/* Image Modal */}
      {selectedImage && (
        <div className="fixed inset-0 bg-white/95 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setSelectedImage(null)}>
          <img src={selectedImage || "/pic.jpg"} alt="Portfolio Image" className="max-w-full max-h-full object-contain rounded-lg shadow-2xl" />
          <Button className="absolute top-4 right-4 bg-[#df0139] text-white hover:bg-[#df0139]/90 rounded-full w-10 h-10 p-0 font-bold" onClick={() => setSelectedImage(null)}>
            ✕
          </Button>
        </div>
      )}
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card className="bg-white border-[#df0139]/20 shadow-lg">
              <CardContent className="p-8">
                <form className="space-y-6">
                  <div>
                    <Input placeholder="Your Name" className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" />
                  </div>
                  <div>
                    <Input type="email" placeholder="Your Email" className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" />
                  </div>
                  <div>
                    <Input placeholder="Phone Number" className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" />
                  </div>
                  <div>
                    <Textarea placeholder="Your Message" className="bg-[#e2e2e2]/30 border-[#28242a]/20 text-[#1e1e27] focus:border-[#df0139] transition-colors" rows={4} />
                  </div>
                  <Button className="w-full bg-[#df0139] text-white hover:bg-[#df0139]/90 rounded-full font-semibold transition-all duration-300 hover:scale-105">
                    Send Message
                  </Button>
